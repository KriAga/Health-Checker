...
Open the project in Pycharm and run the ```Apimedic\web-app\app.py``` file. It will run the flask server. Open the link provided (in my case it was ```http://127.0.0.1:5000/```).  
